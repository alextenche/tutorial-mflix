...
public class ConnectionTest extends TicketTest {
    ...
    public void testConnectionFindsDatabase() {
        ...
        Assert.assertTrue("We can connect to MongoDB, but couldn't find expected database. Check the restore step", found);
    }
    ...
    public void testConnectionFindsCollections() {
        ...
        Assert.assertEquals("Could not find all expected collections. Check your restore step", found, collectionNames.size());
    }
}
